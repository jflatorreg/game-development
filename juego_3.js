...
var Juego_3 = {
	...
	preload: function() {                                             //Se cargan todas las imagenes necesarias para el juego    
        ...
        juego.load.image('sky', 'imagenes/Fondo3.png');               //Fondo del mundo 3  
    ...
    ledge = platforms.create(-250, 250, 'ground2');                             //Se crea la segunda platasforma
    ...
    player.body.bounce.y = 0.5;                                                 //Permitimos que el personaje rebote.
    ...
    if (cursors.up.isDown && player.body.touching.down)                         //Permitimos saltyar al personaje, si toca el suelo
    {
        ...
        if(score>11){                                                           //Cuando se atrapan las 12 estrellas
            score = 0;
			juego.state.start("Final");                                       //se pasa al estado juego2
		}      
	},
}  
