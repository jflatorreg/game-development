...
var Juego = {
	...
	preload: function() {                                             //Se cargan todas las imagenes necesarias para el juego    
        ...
        juego.load.image('sky', 'imagenes/Fondo1.png');               //Fondo del mundo 1  
    ...
    var ledge = platforms.create(200, 400, 'ground2');                          //Creamos las paltaformas
    ledge.body.immovable = true;                                                //Se define las paltaformas como estaticas
    ledge = platforms.create(500, 200, 'ground2');                              //Se crea la segunda platasforma
    ...
    player.body.bounce.y = 0.2;                                                 //Permitimos que el personaje rebote.
    ...
    if (cursors.up.isDown && player.body.touching.down)                         //Permitimos saltyar al personaje, si toca el suelo
    {
        ...
        if(score>11){                                                           //Cuando se atrapan las 12 estrellas
            score = 0;
			juego.state.start("Juego_2");                                       //se pasa al estado juego2
		}      
	},
}  
